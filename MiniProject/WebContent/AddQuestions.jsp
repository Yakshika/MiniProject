...
Answer:      <select name="answer">
             ...
             <input type="submit" value="Done">    <input type="button" onclick="location.href='AdminPanel.jsp'" value="Home" >    <input type="button" onclick="location.href='QuestionList.jsp'" value="Back" >
</pre>
</form>
<div>
<font color="red" >
